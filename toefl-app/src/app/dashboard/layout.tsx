        ...
        <header className="hidden md:flex bg-surface w-full h-16 border-b border-outline-variant sticky top-0 z-10 justify-between items-center px-[var(--spacing-margin-desktop)]">
          <div className="flex-1 flex justify-center">
             <ul className="flex gap-8">
               <li><a className="text-[14px] font-medium text-primary border-b-2 border-primary pb-1" href="#">Dashboard</a></li>
               <li><a className="text-[14px] font-medium text-on-surface-variant hover:text-primary transition-colors" href="#">Practice</a></li>
